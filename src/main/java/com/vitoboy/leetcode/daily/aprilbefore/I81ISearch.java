...
public class I81ISearch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("result is : "+search.search(nums, 0));
        System.out.println("expect is : true");
        nums = new int[]{2,5,6,0,0,1,2};
        System.out.println("result is : "+search.search(nums, 3));
    ...
    static class Search {
        ...
        private boolean equalSearch(int[] nums, int low, int high, int target) {
