...
public class X_MatrixExistPath {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(existUpdate(board, word));

        System.out.println(existUpdate(board1, word1));
        System.out.println(existUpdate(board2, word2));
    ...
    public static boolean existUpdate(char[][] board, String word) {
